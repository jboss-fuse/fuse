 ...
 * on jboss-fuse-karaf-full assembly
 */
public class EsbKarafFullCoreFeaturesTest extends EsbCoreFeaturesTest {

    @Configuration
    public Option[] config() {
        return new Option[]{
                new DefaultCompositeOption(esbDistributionConfiguration("jboss-fuse-karaf-full")),
        };
    }
