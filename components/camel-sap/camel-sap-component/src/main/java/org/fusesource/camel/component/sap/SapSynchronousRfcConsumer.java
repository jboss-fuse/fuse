 ...
 *
 */
public class SapSynchronousRfcConsumer extends DefaultConsumer implements JCoServerFunctionHandler {

	private static final Logger LOG = LoggerFactory.getLogger(SapSynchronousRfcConsumer.class);

	Map<String, Object> sessionData = new HashMap<String, Object>();

	public SapSynchronousRfcConsumer(Endpoint endpoint, Processor processor) {
