...
/**
 * Represents an SAP endpoint providing outbound RFC (Remote Function Call) communication to SAP.
 * 
 * @author William Collins <punkhornsw@gmail.com>
 *
 */
@UriEndpoint(scheme="sap-srfc-destination")
public class SapSynchronousRfcDestinationEndpoint extends DefaultEndpoint {
	...
	public SapSynchronousRfcDestinationEndpoint(String endpointUri, Component component) {
