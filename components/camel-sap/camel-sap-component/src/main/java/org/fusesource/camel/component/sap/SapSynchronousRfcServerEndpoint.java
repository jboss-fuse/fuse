...
/**
 * Represents an SAP endpoint providing inbound synchronous RFC (Remote Function Call) communication from SAP.
 * 
 * @author William Collins <punkhornsw@gmail.com>
 *
 */
@UriEndpoint(scheme="sap-srfc-server")
public class SapSynchronousRfcServerEndpoint extends DefaultEndpoint {
	...
	public SapSynchronousRfcServerEndpoint(String endpointUri, Component component) {
